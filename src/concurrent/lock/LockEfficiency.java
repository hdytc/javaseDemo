...
public class LockEfficiency extends Thread {
        ...
        static {
            try {
                ...
                casOffset = UNSAFE.staticFieldOffset(LockEfficiency.class.getDeclaredField("cas"));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        public void cas(){
            ...
            while(!bl){
                tmp = cas;
                bl = UNSAFE.compareAndSwapInt(LockEfficiency.class, casOffset, tmp,tmp+1);
            }
        }
...
/*            synchronized(getClass()){
        ...
        public static void main(String[] args){
            ...
            //结论：LongArddr > AtomicInteger > synchronized > cas
        }
