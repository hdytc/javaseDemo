...
/**
 * Specialization of the SelectSockets class which uses a thread pool to webservice
...
public class SelectSocketsThreadPool extends SelectSockets
{
     ...
     * delegates（委托） to a worker thread in a thread pool to webservice the channel,
     ...
     * webservice the channel associated with a SelectionKey object. The worker is
